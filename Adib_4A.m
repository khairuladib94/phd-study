%Input---------------------------------------------------------------------
stn='DAV';                           %Abbreviation of station name
station='Davao';                %Station full name
...
bin_1=round((901/0.5)*f_A1);
bin_2=round((901/0.5)*f_A2);
...
for i=1:size(H_30min,2)
        [H_welch,f]=pwelch(H_30min(:,i),1800,[],1800,f_s);
        H_welch=abs(H_welch(bin_1:bin_2));
        H_wmu(j,k)=mean(H_welch);
        
        [D_welch,f]=pwelch(D_30min(:,i),1800,[],1800,f_s);
        D_welch=abs(D_welch(bin_1:bin_2));
        D_wmu(j,k)=mean(D_welch);
        
        [Z_welch,f]=pwelch(Z_30min(:,i),1800,[],1800,f_s);
...
bin_1=round((901/0.5)*f_B1);
bin_2=round((901/0.5)*f_B2);
...
bin_1=round((901/0.5)*f_C1);
bin_2=round((901/0.5)*f_C2);
